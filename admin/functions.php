...
function rd_adminRegisterAssets() {
  wp_register_style( 'car-info-rd-admin-styles', plugins_url( 'car-info-rd/admin/assets/css/styles.css' ) );
	wp_register_script( 'car-info-rd-admin-jquery', plugins_url( 'car-info-rd/admin/assets/js/jquery-3.5.1.min.js') );
