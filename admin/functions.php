...
function rd_adminRegisterAssets() {
  wp_register_style( 'car-info-rd-admin-styles', plugins_url('cars-info-rd-1.1.0/admin/assets/css/styles.css' ) );
	wp_register_script( 'car-info-rd-admin-jquery', plugins_url('cars-info-rd-1.1.0/admin/assets/js/jquery-3.5.1.min.js' ) );
