...
function rd_adminRegisterAssets() {
  wp_register_style( 'car-info-rd-admin-styles', plugin_dir_path( __FILE__ . 'admin/assets/css/styles.css') );
	wp_register_script( 'car-info-rd-admin-jquery', plugin_dir_path( __FILE__ . 'admin/assets/js/jquery-3.5.1.min.js') );
