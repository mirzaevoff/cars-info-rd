...
function rd_registerAssets() {
  wp_register_style( 'car-info-rd-styles', plugin_dir_path( __FILE__ . 'cars-info-rd-1.0.6/assets/css/' ) );
	wp_register_script( 'car-info-rd-jquery', plugin_dir_path( __FILE__ . 'cars-info-rd-1.0.6/assets/js/jquery-3.5.1.min.js') );
